...
import plm.difexemples.ClientComponent;
import plm.difexemples.SingletonComponent;
import plm.difexemples.TransientComponent;
...
// Note that every time an instance is required, the DI returns t same unique one
